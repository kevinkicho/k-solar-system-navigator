...
- **Ephemeris fidelity** — product default **L2-plan** offline sample-table endpoints (8 planets, **2015–2055 @ 3 d**; falls back to approx OOR). Opt-in **L2-horizons** live endpoint inject (network) for Need. Optional L2-compare (Horizons Δr only). Animation stays L1 Approximate Positions. Classroom forces offline L1. **Not DE/SPICE kernels.**
