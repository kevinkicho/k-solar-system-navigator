...
- **Ephemeris fidelity** — product default **L2-plan** offline sample table baked from **JPL Horizons VECTORS** (8 planets, **2015–2055 @ 3 d**, HELIOS scene axes; rebuild: `npm run build:ephemeris`). Opt-in **L2-horizons** live inject for Need. Optional L2-compare (Δr only). Animation stays L1 Approximate Positions. Classroom forces offline L1. **Not SPICE kernels / not flight ops.**
