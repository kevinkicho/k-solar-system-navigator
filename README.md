...
- **Ephemeris fidelity** — product default **L2-plan** offline sample-table endpoints for Lambert Need (8 planets; falls back to approx when OOR); animation stays L1 Approximate Positions. Optional L2-compare (Horizons Δr only). Classroom mode forces offline L1. **Not DE/SPICE kernels.**
